                ...
                <div class="card-body">
                    ...
                    <form class="form-horizontal" action="{{route('sub-category.store')}}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-md-9">
                                <input class="form-control" value="{{old('name')}}" id="subName" name="name" placeholder="Sub Category Name" type="text"/>
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-md-9">
                                <textarea class="form-control" id="subDescription" name="description" placeholder="Sub Category Description"></textarea>
                            </div>
                        </div>
                        <div class="row mb-4">
                        ...
                        <button class="btn btn-primary rounded-0" type="submit">Create New Sub Category</button>
                    </form>
                </div>
            </div>
        </div>
