            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form class="form-horizontal" action="{{route('sub-category.update', $sub_category->id)}}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="row mb-4">
                            <label for="subName" class="col-md-3 form-label">Sub Category Name</label>
                            <div class="col-md-9">
                                <input class="form-control" value="{{$sub_category->name}}" id="subName" name="name" placeholder="Sub Category Name" type="text"/>
                                <span class="text-danger">{{$errors->has('name') ? $errors->first('name') : ''}}</span>
                            </div>
                        </div>
                        <div class="row mb-4">
                            <label for="subDescription" class="col-md-3 form-label">Sub Category Description</label>
                            <div class="col-md-9">
                                <textarea class="form-control" id="subDescription" name="description" placeholder="Sub Category Description">{{$sub_category->description}}</textarea>
                            </div>
                        </div>
                        <div class="row mb-4">
                        ...
                        <button class="btn btn-primary rounded-0" type="submit">Update Sub Category Info</button>
                    </form>
                </div>
            </div>
        </div>
